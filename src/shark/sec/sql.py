...
submissions = Table(
    ...
    Column("entity_type", String, doc="Type of company standing (e.g., operating)."),
    ...
    Column("tickers", String, doc="Comma-separated tickers/symbols the company uses."),
    Column(
        "exchanges", String, doc="Comma-separated exchanges the company is found on."
    ),
...
tags = Table(
    ...
    Column("accn", String, primary_key=True, doc="Unique submission/access number."),
    Column("taxonomy", String, doc="XBRL taxonomy the submission's tag belongs to."),
    Column(
        "tag",
        String,
        primary_key=True,
    ...
    Column(
        "units", String, doc="Unit of measurements for tag value (e.g., USD or shares)."
    ),
    Column("fy", Integer, doc="Fiscal year the submission is for."),
    Column("fp", String, doc="Fiscal period the submission is for (e.g., Q1 or FY)."),
    Column(
        "start",
        String,
        nullable=True,
    ...
    Column(
        "frame", String, nullable=True, doc="Often a concatenation of `fy` and `fp`."
    ),
    Column("label", String, nullable=True, doc="More human readable version of `tag`."),
    Column(
        "description",
        String,
        nullable=True,
