...
http_cache_path = os.environ.get(
    "SHARK_HTTP_CACHE_PATH", project_path / "data" / "http_cache"
)
...
database_path = project_path / "data" / "shark.sqlite"
database_url = os.environ.get("SHARK_DATABASE_URL", f"sqlite:///{database_path}")
